...
// Removed: ILiquidityGauge - governance/liquidity mining feature, not core to leveraged trading
...
contract FxUSDBasePoolFacet {
  ...
  function migrateToFxBaseGauge(address pool, uint256 amountIn, uint256 minShares, address receiver) external {
    ...
    // Removed: ILiquidityGauge deposit - governance/liquidity mining feature, not core to leveraged trading
  ...
  function redeemFromFxBaseGauge(
    ...
    // Removed: ILiquidityGauge withdraw - governance/liquidity mining feature, not core to leveraged trading
